...
CRGBPalette16 gCurrentPalette1( LavaColors_p);
CRGBPalette16 gCurrentPalette2( CloudColors_p);
CRGBPalette16 gCurrentPalette3( OceanColors_p);
/////////////////////////////////////////////////////////////////
...
void paletteTest1() // CRGB* ledarray, uint16_t numleds, const CRGBPalette16& gCurrentPalette)
{
  static uint8_t startindex = 0;
  startindex--;
  fill_palette( leds1, NUM_LEDS1, startindex, (256 / NUM_LEDS1) + 1, gCurrentPalette1, 255, LINEARBLEND);
  fill_palette( leds2, NUM_LEDS2, startindex, (256 / NUM_LEDS2) + 1, gCurrentPalette1, 255, LINEARBLEND);
  fill_palette( leds3, NUM_LEDS3, startindex, (256 / NUM_LEDS3) + 1, gCurrentPalette1, 255, LINEARBLEND);
}

void paletteTest2() // CRGB* ledarray, uint16_t numleds, const CRGBPalette16& gCurrentPalette)
{
  static uint8_t startindex = 0;
  startindex--;
  fill_palette( leds1, NUM_LEDS1, startindex, (256 / NUM_LEDS1) + 1, gCurrentPalette2, 255, LINEARBLEND);
  fill_palette( leds2, NUM_LEDS2, startindex, (256 / NUM_LEDS2) + 1, gCurrentPalette2, 255, LINEARBLEND);
  fill_palette( leds3, NUM_LEDS3, startindex, (256 / NUM_LEDS3) + 1, gCurrentPalette2, 255, LINEARBLEND);
}

void paletteTest3() // CRGB* ledarray, uint16_t numleds, const CRGBPalette16& gCurrentPalette)
{
  static uint8_t startindex = 0;
  startindex--;
  fill_palette( leds1, NUM_LEDS1, startindex, (256 / NUM_LEDS1) + 1, gCurrentPalette3, 255, LINEARBLEND);
  fill_palette( leds2, NUM_LEDS2, startindex, (256 / NUM_LEDS2) + 1, gCurrentPalette3, 255, LINEARBLEND);
  fill_palette( leds3, NUM_LEDS3, startindex, (256 / NUM_LEDS3) + 1, gCurrentPalette3, 255, LINEARBLEND);
}
